...
export const AutoStartMethodField = ({ helpText }: AutoStartMethodFieldProps): JSX.Element => {
    ...
    return (
        <FormControl>
            ...
            <FormHelperText>
                {helpText ?? (
                    'Select whether you want the xMessage Server to automatically start when you login to your computer. ' +
                    'The "Launch Agent" option will let xMessage restart itself, even after a hard crash. If you try to ' +
