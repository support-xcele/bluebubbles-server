        ...
        <SlideFade in={true} offsetY='150px'>
            <Box px={5}>
                ...
                <Text fontSize='md' mt={5}>
                    In order for you to be able to connect to this xMessage server from the internet, you'll need
                    to either setup a Dynamic DNS or use one of the integrated proxy services. Proxy services create
                    a tunnel from your macOS device to your xMessage clients. It does this by routing all communications
                    from your xMessage server, through the proxy service's servers, and to your xMessage client. Without
                    this, your xMessage server will only be accessible on your local network.
                </Text>
                <Text fontSize='md' mt={5}>
                    Now, we also do not want anyone else to be able to access your xMessage server except you, so we have
                    setup password-based authentication. All clients will be required to provide the password in order to
                    interact with the xMessage Server's API.
                </Text>
                <Text fontSize='md' mt={5}>
