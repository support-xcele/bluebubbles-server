        ...
        <SlideFade in={true} offsetY='150px'>
            ...
            >
                ...
                <Text fontSize='md' mt={5} mb={5}>
                    Xcelerate Management utilizes Google FCM (Firebase Cloud Messaging) to deliver notifications and server URL changes to your Xcelerate Management clients.
                    We do this so the clients do not need to hold a connection to the server at all times. As a result,
                    Xcelerate Management can deliver notifications even when the app is running in the background. This is also used to
                    ensure your current server URL is always synced to your Xcelerate Management clients.
                </Text>
                {getAlertStatus()}
                <Box mt={3} />
                <Tabs>
                    ...
                    <TabPanels>
                        <TabPanel>
                            <Text fontSize='md'>
                                Using the button below, you can authorize Xcelerate Management to manage your Google Cloud Platform account temporarily.
                                This will allow Xcelerate Management to automatically create your Firebase project and setup the necessary configurations
