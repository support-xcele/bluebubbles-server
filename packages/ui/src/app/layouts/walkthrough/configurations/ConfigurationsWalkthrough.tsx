        ...
        <SlideFade in={true} offsetY='150px'>
            <Box px={5}>
                ...
                <Text fontSize='md' mt={5}>
                    Congratulations, you have completed the xMessage Server setup! Here are some useful features that
                    you may want to checkout to customize your xMessage experience!
                </Text>
