        ...
        <SlideFade in={true} offsetY='150px'>
            <Box px={5}>
                ...
                <Text fontSize='md' mt={5}>
                    Before setting up xMessage, we need to make sure that the app is given the correct permissions
                    so that it can operate. The main permission that is required is the <strong>Full Disk Access</strong>&nbsp;
                    permission. This will allow xMessage to read the iMessage database and provide notifications for
                    new messages. Accessibility permissions are optional and are not required for the base xMessage functionality.
                </Text>
                <Text fontSize='md' mt={5}>
                    Here is an evaluation of your current permissions. If Full Disk Access is not enabled, you will not be
                    able to use xMessage
                </Text>
                <Box my={3} />
