...
export const ContactsLayout = (): JSX.Element => {
    ...
    const getEmptyContent = () => {
        ...
        if (contacts.length === 0) {
            return wrap(<Text fontSize="md">Xcelerate Management found no contacts in your Mac's Address Book!</Text>);
        }
    ...
    return (
        <Box p={3} borderRadius={10}>
            ...
            <Box ml={5} mr={5}>
                <Text fontSize='md'>
                    Using the button below, you can authorize Xcelerate Management to access your Google Contacts. This will allow Xcelerate Management to
                ...
                <Flex flexDirection='row' justifyContent='flex-start' alignItems='center'>
                    ...
                    <Popover trigger='hover'>
                        ...
                        <PopoverContent>
                            ...
                            <PopoverBody>
                                <Text>
                                    Here are the contacts on your macOS device that Xcelerate Management knows about,
