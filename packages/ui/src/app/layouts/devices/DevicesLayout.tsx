...
const confirmationActions: ConfirmationItems = {
    clearDevices: {
        message: (
            ...
            'Doing so will mean you will have to re-register your Xcelerate Management client ' +
                ...
                <Flex flexDirection='row' justifyContent='flex-start' alignItems='center'>
                    ...
                    <Popover trigger='hover'>
                        ...
                        <PopoverContent>
                            ...
                            <PopoverBody>
                                <Text>
                                    Here is where you'll find any devices that are registered with your Xcelerate Management
